...
<!--                        </DropdownMenuItem>-->
                        <DropdownMenuItem @click="logInAppleMusicAccount">
...
const logInAppleMusicAccount = () => {
  ...
  const loginWindow = new WebviewWindow('apple-music-login', {
    url: 'https://music.apple.com',
    title: 'Log in Apple Music Account',
    width: 800,
    height: 600,
    resizable: false,
    transparent: false,
  ...
  loginWindow.once('tauri://created', function () {
    toast.success('Apple Music Login Window Created')
  })
  loginWindow.once('tauri://error', function (e) {
    toast.error('Apple Music Login Window Creation Failed')
    console.log(e)
  })
  // 监听窗口关闭事件
  loginWindow.once('tauri://close', () => {
    toast.warning('Apple Music Login Window Closed')
  })
